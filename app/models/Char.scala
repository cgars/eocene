...
object Char {
   ...
   */
  def updateCharAttributeWithPP(id: Int, attribute: String, direction: String)(implicit c: Connection): Boolean = {
   ...
   * @return Succes indicator
   */
  def updateCharAttributeWithLP(id: Int, attribute: String, direction: String)(implicit c: Connection): Boolean = {
    val current_value = getCharAttribute(id, attribute)
   ...
   * @return success
   */
  def corruptCharTalent(id: Int, id_talent: Int)(implicit c: Connection): Boolean = {
    val talents = getCharTalentRowsIdByCharId(id)
    val target_talent = talents.filter(a => a(1) == id_talent)
   ...
   * @return success
   */
  def improveCharSkill(id: Int, id_skill: Int)(implicit c: Connection): Boolean = {
